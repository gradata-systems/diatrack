...
namespace Diatrack.Models
{
    ...
    public class DexcomBglReadingJsonConverter : JsonConverter<DexcomBglReading>
    {
        private static readonly Regex _datePattern = new(@"^/Date\((\d+)\)/$", RegexOptions.Compiled);

        public override DexcomBglReading Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
        ...
        public override void Write(Utf8JsonWriter writer, DexcomBglReading value, JsonSerializerOptions options)
        {
