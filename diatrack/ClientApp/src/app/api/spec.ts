...
export class Client {
     ...
     */
    subscribe(body: Body2 | undefined): Observable<Anonymous> {
    ...
    protected processSubscribe(response: HttpResponseBase): Observable<Anonymous> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class HoneyBee extends Pet implements IHoneyBee {
    ...
    static fromJS(data: any): HoneyBee {
        data = typeof data === 'object' ? data : {};
        let result = new HoneyBee();
        result.init(data);
        return result;
...
export class Order implements IOrder {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.shipDate = _data["shipDate"] ? moment.parseZone(_data["shipDate"].toString()) : <any>undefined;
            this.status = _data["status"];
    ...
    toJSON(data?: any) {
        ...
        data["shipDate"] = this.shipDate ? this.shipDate.toISOString(true) : <any>undefined;
        data["status"] = this.status;
